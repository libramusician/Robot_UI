!function(e, t) {
    ...
    return function(e) {
        ...
        e.exports = function(e) {
            return '<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100%" version="1.1" viewBox="' + i[e][0] + '" width="100%"><use xlink:href="#dplayer-' + e + '"></use><path class="dplayer-fill" d="' + i[e][1] + '" id="dplayer-' + e + '"></path></svg>\n'
        }
    }
    , function(e, t, n) {
        "use strict";
        ...
        var l = n(4)
          ...
          , T = function() {
            function e(t) {
                ...
                this.option.video.quality && (this.qualityIndex = this.option.video.defaultQuality,
                ...
                var i = {};
                i.volumeBar = this.element.getElementsByClassName("dplayer-volume-bar-inner")[0],
                i.playedBar = this.element.getElementsByClassName("dplayer-played")[0],
                i.loadedBar = this.element.getElementsByClassName("dplayer-loaded")[0];
                ...
                this.option.danmaku && (this.danmaku = new f.default({
                    container: this.element.getElementsByClassName("dplayer-danmaku")[0],
                    opacity: localStorage.getItem("danmaku-opacity") || .7,
                    callback: function() {
                        n.element.getElementsByClassName("dplayer-danloading")[0].style.display = "none",
                        n.option.autoplay && !l.isMobile ? n.play() : l.isMobile && n.pause()
                    },
                    error: function(e) {
                        n.notice(e)
                    },
                ...
                var h = this.element.getElementsByClassName("dplayer-video-wrap")[0]
                  , y = this.element.getElementsByClassName("dplayer-controller-mask")[0];
                if (l.isMobile) {
                    var g = function() {
                ...
                var T = function() {
                    n.checkLoading = setInterval(function() {
                        ...
                        !E && b < k + .01 && !n.video.paused && (n.element.classList.add("dplayer-loading"),
                        E = !0),
                        E && b > k + .01 && !n.video.paused && (n.element.classList.remove("dplayer-loading"),
                        E = !1),
                        k = b
                    }, 100)
                }
                ...
                this.animationFrame = function() {
                    ...
                    n.element.getElementsByClassName("dplayer-ptime")[0].innerHTML = o.default.secondToTime(n.video.currentTime)),
                ...
                this.setTime = function(e) {
                    e ? (n[e + "Time"] = !0,
                    "played" === e && T()) : (n.playedTime = !0,
                    T())
                }
                ,
                this.clearTime = function(e) {
                    e ? (n[e + "Time"] = !1,
                    "played" === e && q()) : (n.playedTime = !1,
                    q())
                }
                ,
                ...
                var B = function(e) {
                    ...
                    n.element.getElementsByClassName("dplayer-ptime")[0].innerHTML = o.default.secondToTime(i * n.video.duration)
                }
                  , C = function e() {
                ...
                this.switchVolumeIcon = function() {
                    ...
                    n.volume() >= .95 ? e.innerHTML = (0,
                    d.default)("volume-up") : n.volume() > 0 ? e.innerHTML = (0,
                    d.default)("volume-down") : e.innerHTML = (0,
                    d.default)("volume-off")
                }
                ;
                var _ = function(e) {
                    var t = e || window.event
                ...
                l.isMobile || (this.element.addEventListener("mousemove", P),
                ...
                var A = function() {
                    I.classList.contains("dplayer-setting-box-open") && (I.classList.remove("dplayer-setting-box-open"),
                ...
                var V = !0
                  , j = function() {
                    ...
                    n.element.getElementsByClassName("dplayer-setting-speed")[0].addEventListener("click", function() {
                        ...
                        I.innerHTML = D.speed;
                        for (var e = I.getElementsByClassName("dplayer-setting-speed-item"), t = 0; t < e.length; t++)
                            !function(t) {
                    ...
                    n.danmaku) {
                        i.danmakuBar = n.element.getElementsByClassName("dplayer-danmaku-bar-inner")[0];
                        var l = n.element.getElementsByClassName("dplayer-danmaku-bar-wrap")[0]
                          , r = n.element.getElementsByClassName("dplayer-danmaku-bar")[0]
                ...
                j(),
                1 !== this.video.duration && (this.element.getElementsByClassName("dplayer-dtime")[0].innerHTML = this.video.duration ? o.default.secondToTime(this.video.duration) : "00:00"),
                this.danmaku || (this.option.autoplay && !l.isMobile ? this.play() : l.isMobile && this.pause());
                var W = this.element.getElementsByClassName("dplayer-comment-input")[0]
                  , X = this.element.getElementsByClassName("dplayer-comment-icon")[0]
                  , Q = this.element.getElementsByClassName("dplayer-comment-box")[0]
                  , $ = this.element.getElementsByClassName("dplayer-comment-setting-icon")[0]
                  , U = this.element.getElementsByClassName("dplayer-comment-setting-box")[0]
                  , Y = this.element.getElementsByClassName("dplayer-send-icon")[0]
                  , J = function() {
                    U.classList.contains("dplayer-comment-setting-open") && U.classList.remove("dplayer-comment-setting-open")
                }
                  , G = function() {
                    U.classList.contains("dplayer-comment-setting-open") ? U.classList.remove("dplayer-comment-setting-open") : U.classList.add("dplayer-comment-setting-open")
                }
                  , K = 0
                  , Z = 0
                  , ee = function() {
                    Q.classList.contains("dplayer-comment-box-open") && (Q.classList.remove("dplayer-comment-box-open"),
                    R.classList.remove("dplayer-mask-show"),
                  ...
                  , te = function() {
                    Q.classList.contains("dplayer-comment-box-open") || (Q.classList.add("dplayer-comment-box-open"),
                    R.classList.add("dplayer-mask-show"),
                ...
                this.element.getElementsByClassName("dplayer-comment-setting-color")[0].addEventListener("click", function() {
                    n.element.querySelector('input[name="dplayer-danmaku-color-${index}"]:checked+span') && ($.getElementsByClassName("dplayer-fill")[0].style.fill = n.element.querySelector('input[name="dplayer-danmaku-color-${index}"]:checked').value)
                });
                var ne = function() {
                    if (W.blur(),
                    !W.value.replace(/^\s+|\s+$/g, ""))
                ...
                if (this.element.addEventListener("contextmenu", function(e) {
                    var t = e || window.event;
                    t.preventDefault(),
                    ae.classList.add("dplayer-menu-show");
                    var i = n.element.getBoundingClientRect()
                      , a = t.clientX - i.left
                      , s = t.clientY - i.top;
                    a + ae.offsetWidth >= i.width ? (ae.style.right = i.width - a + "px",
                    ae.style.left = "initial") : (ae.style.left = t.clientX - n.element.getBoundingClientRect().left + "px",
                    ae.style.right = "initial"),
                    s + ae.offsetHeight >= i.height ? (ae.style.bottom = i.height - s + "px",
                    ae.style.top = "initial") : (ae.style.top = t.clientY - n.element.getBoundingClientRect().top + "px",
                ...
                this.option.screenshot) {
                    var se = this.element.getElementsByClassName("dplayer-camera-icon")[0];
            ...
            return s(e, [{
                ...
                value: function(e) {
                    ...
                    this.video.currentTime < e ? this.notice(this.tran("FF to") + " " + o.default.secondToTime(e)) : this.video.currentTime > e && this.notice(this.tran("REW to") + " " + o.default.secondToTime(e)),
                ...
                value: function() {
                    this.paused = !1,
                    this.video.paused && (this.bezel.innerHTML = (0,
                    d.default)("play"),
                    this.bezel.classList.add("dplayer-bezel-transition")),
                    this.playButton.innerHTML = (0,
                    d.default)("pause"),
                    this.video.play(),
                    this.setTime(),
                ...
                value: function(e, t, n) {
                    ...
                    t || this.notice(this.tran("Volume") + " " + (100 * e).toFixed(0) + "%"),
                    this.video.volume = e,
                ...
                value: function(e, t) {
                    ...
                    t && (this.element.getElementsByClassName("dplayer-danloading")[0].style.display = "block",
                ...
                value: function(e, t) {
                    if (this.type = t,
                    "auto" === this.type && (/m3u8(#|\?|$)/i.exec(e.src) ? this.type = "hls" : /.flv(#|\?|$)/i.exec(e.src) ? this.type = "flv" : this.type = "normal"),
                ...
                value: function(e, t) {
                    ...
                    this.on("durationchange", function() {
                        1 !== e.duration && (n.element.getElementsByClassName("dplayer-dtime")[0].innerHTML = o.default.secondToTime(e.duration))
                    }),
                    ...
                    this.volume(localStorage.getItem("dplayer-volume") || this.option.volume, !0, !0)
                }
            }, {
                key: "switchQuality",
                value: function(e) {
                    ...
                    if (this.qualityIndex !== e && !this.switchingQuality) {
                        ...
                        this.video.pause();
                        var i = v.default.video(!1, null, this.option.screenshot, "auto", this.quality.url)
                          , a = (new DOMParser).parseFromString(i, "text/html").body.firstChild
                          , s = this.element.getElementsByClassName("dplayer-video-wrap")[0];
                ...
                value: function() {
                    var e = this;
                    this.thumbnails = new k.default(this.element.getElementsByClassName("dplayer-bar-preview")[0],this.element.getElementsByClassName("dplayer-bar-wrap")[0].offsetWidth,this.option.video.thumbnails,this.events),
                ...
                value: function(e) {
                    var t = this
                      ...
                      , a = this.element.getElementsByClassName("dplayer-notice")[0];
                    a.innerHTML = e,
                    a.style.opacity = i,
        ...
        var i = n(0)
          , a = {
            ...
            video: function(e, t, n, i, a) {
                return '<video class="dplayer-video ' + (e ? 'dplayer-video-current"' : "") + '" ' + (t ? 'poster="' + t + '"' : "") + " webkit-playsinline playsinline " + (n ? 'crossorigin="anonymous"' : "") + " " + (i ? 'preload="' + i + '"' : "") + ' src="' + a + '"></video>'
            },
            setting: function(e) {
                return {
                    original: '<div class="dplayer-setting-item dplayer-setting-speed"><span class="dplayer-label">' + e("Speed") + '</span><div class="dplayer-toggle">' + i("right") + '</div></div><div class="dplayer-setting-item dplayer-setting-loop"><span class="dplayer-label">' + e("Loop") + '</span><div class="dplayer-toggle"><input class="dplayer-toggle-setting-input" type="checkbox" name="dplayer-toggle"><label for="dplayer-toggle"></label></div></div><div class="dplayer-setting-item dplayer-setting-showdan"><span class="dplayer-label">' + e("Danmaku") + '</span><div class="dplayer-toggle"><input class="dplayer-showdan-setting-input" type="checkbox" name="dplayer-toggle-dan"><label for="dplayer-toggle-dan"></label></div></div><div class="dplayer-setting-item dplayer-setting-danmaku"><span class="dplayer-label">' + e("Opacity for danmaku") + '</span><div class="dplayer-danmaku-bar-wrap"><div class="dplayer-danmaku-bar"><div class="dplayer-danmaku-bar-inner" style="width: ' + 100 * (localStorage.getItem("DPlayer-opacity") || .7) + '%"><span class="dplayer-thumb"></span></div></div></div></div>',
            ...
            return s(e, [{
                ...
                value: function(e, t) {
                    for (var n = this, i = [], a = 0, s = 0; s < e.length; ++s)
                        this.options.apiBackend.read(e[s], function(s) {
                            return function(l, o) {
                                if (++a,
                                l ? (l.response ? n.options.error(l.response.msg) : n.options.error("Request was unsuccessful: " + l.status),
                                i[s] = []) : i[s] = o,
                                a === e.length)
                                    return t(i)
                            }
                ...
                value: function(e) {
                    var t = this
                      ...
                      , d = function(e, n, s) {
                        for (var d = i / r(s), c = 0; t.options.unlimited || c < l; c++) {
                            var u = function(a) {
                    ...
                    for (var c = document.createDocumentFragment(), u = 0; u < e.length; u++)
                        !function(a) {
                            ...
                            o >= 0 && (s.classList.add("dplayer-danmaku-move"),
                            c.appendChild(s))
                        }(u);
          ...
          , s = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    switch (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "browser") {
                    case "browser":
                        this.player.element.requestFullscreen ? this.player.element.requestFullscreen() : this.player.element.mozRequestFullScreen ? this.player.element.mozRequestFullScreen() : this.player.element.webkitRequestFullscreen ? this.player.element.webkitRequestFullscreen() : this.player.video.webkitEnterFullscreen && this.player.video.webkitEnterFullscreen();
                        break;
                    case "web":
